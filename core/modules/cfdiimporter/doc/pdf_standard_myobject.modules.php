...
/**
 *  \file       cfdiimporter/core/modules/cfdiimporter/doc/pdf_standard.modules.php
...
class pdf_standard_myobject extends ModelePDFMyObject
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->cfdiimporter->dir_output . '/myobject') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->cfdiimporter->dir_output . '/myobject';
				$file = $dir . "/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->cfdiimporter->dir_output . '/myobject/' . $objectref;
